"""
GPS-Only vs Sensor Fusion Comparison Test
Compares the effectiveness of GPS spoofing attacks on GPS-only vs sensor fusion systems.
This demonstrates the benefits of sensor fusion for GPS spoofing mitigation.
"""
import numpy as np
import time
import sys
